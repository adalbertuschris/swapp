...
const convertObjectKeys = <T extends object, R extends object>(obj: T, converter: (objectKey: string) => string): R => {
...
export const mapResponseToCamelCase = <T extends object, R extends object>(obj: T): R =>
  convertObjectKeys(obj, snakeToCamel);
